...
const wordLists = {
    cet6: [
        ...
        'YOUTH', 'ABANDON', 'ABSOLUTE', 'ABSTRACT', 'ABUNDANT', 'ACCURATE', 'ACCUSTOM', 'ACKNOWLEDGE', 'ACQUAINT', 'ACQUAINTANCE',
        'ADAPT', 'ADDICT', 'ADDRESS', 'ADEQUATE', 'ADHERE', 'ADJACENT', 'ADJOIN', 'ADJOURN', 'ADMINISTER', 'ADMIRABLE',
        'ADMISSION', 'ADMIT', 'ADOPT', 'ADORE', 'ADVANCE', 'ADVENTURE', 'ADVERSE', 'ADVERTISE', 'ADVISABLE', 'ADVOCATE',
        'AESTHETIC', 'AFFECTION', 'AFFILIATE', 'AFFIRM', 'AFFORD', 'AFTERMATH', 'AGENDA', 'AGGRESSIVE', 'AGONY', 'AGREEABLE',
        'AILMENT', 'ALARM', 'ALBUM', 'ALCOHOL', 'ALERT', 'ALIEN', 'ALIGN', 'ALLEGE', 'ALLEVIATE', 'ALLOCATE',
        'ALLOWANCE', 'ALLUDE', 'ALLURE', 'ALLY', 'ALMIGHTY', 'ALTERNATE', 'ALTITUDE', 'ALUMINUM', 'AMATEUR', 'AMAZE',
        'AMBIGUOUS', 'AMBITION', 'AMBULANCE', 'AMEND', 'AMENITY', 'AMID', 'AMMUNITION', 'AMONG', 'AMPLIFY', 'ANALOGUE',
        'ANALYZE', 'ANCESTOR', 'ANCHOR', 'ANCIENT', 'ANECDOTE', 'ANGLE', 'ANGUISH', 'ANIMATE', 'ANKLE', 'ANNIVERSARY',
        'ANNOUNCE', 'ANNOY', 'ANNUAL', 'ANONYMOUS', 'ANTICIPATE', 'ANTIQUE', 'ANTONYM', 'ANXIETY', 'APART', 'APARTMENT',
        'APOLOGY', 'APPALL', 'APPARATUS', 'APPARENT', 'APPEAL', 'APPEASE', 'APPENDIX', 'APPETITE', 'APPLAUD', 'APPLIANCE',
        'APPLICANT', 'APPOINT', 'APPRAISE', 'APPROACH', 'APPROPRIATE', 'APPROVE', 'APPROXIMATE', 'APRON', 'APT', 'APTITUDE',
        'ARBITRARY', 'ARBITRATE', 'ARCH', 'ARCHAEOLOGY', 'ARCHITECT', 'ARCHIVE', 'ARDUOUS', 'ARENA', 'ARGUE', 'ARISE',
        'ARITHMETIC', 'ARMOR', 'AROMA', 'ARRAY', 'ARROGANT', 'ARTERY', 'ARTICULATE', 'ARTIFACT', 'ARTIFICIAL', 'ARTISTIC',
        'ASCEND', 'ASCERTAIN', 'ASHAMED', 'ASIDE', 'ASPIRATION', 'ASSAULT', 'ASSEMBLE', 'ASSERT', 'ASSESS', 'ASSET',
        'ASSIGN', 'ASSIMILATE', 'ASSIST', 'ASSOCIATE', 'ASSUME', 'ASSURANCE', 'ASTONISH', 'ASTRONOMY', 'ASYLUM', 'ATHLETE',
        'ATMOSPHERE', 'ATOM', 'ATROCIOUS', 'ATTACH', 'ATTENDANCE', 'ATTENTIVE', 'ATTIC', 'ATTIRE', 'ATTRACT', 'ATTRIBUTE',
        'AUDIENCE', 'AUDIO', 'AUDIT', 'AUGMENT', 'AUNT', 'AUSTERE', 'AUTHENTIC', 'AUTHORITY', 'AUTHORIZE', 'AUTOMATIC',
        'AUTONOMY', 'AUXILIARY', 'AVALANCHE', 'AVERAGE', 'AVERT', 'AVIATION', 'AVOID', 'AWAKE', 'AWARD', 'AWARE',
        'AWFUL', 'AWKWARD', 'AXIS', 'BACHELOR', 'BACKWARD', 'BACON', 'BACTERIA', 'BADGE', 'BADLY', 'BAFFLE',
        'BAGGAGE', 'BAKE', 'BALANCE', 'BALCONY', 'BALD', 'BALLOT', 'BAMBOO', 'BAN', 'BANANA', 'BANDAGE'
    ],
    ielts: [
        ...
        'ABSOLUTION', 'ABSTRACTION', 'ACCELERATION', 'ACCLIMATIZATION', 'ACCOMMODATE', 'ACCOMPLISHMENT', 'ACCUMULATION', 'ACCURACY', 'ACKNOWLEDGMENT', 'ACQUISITION',
        'ADMINISTRATION', 'ADMIRATION', 'ADVANCEMENT', 'ADVERTISING', 'AESTHETICS', 'AFFORDABILITY', 'AGGREGATION', 'ALLEGIANCE', 'ALLOCATION', 'ALTERATION',
        'AMALGAMATION', 'AMBIVALENCE', 'AMELIORATION', 'AMPLIFICATION', 'ANALYSIS', 'ANTHROPOLOGY', 'ANTICIPATION', 'APPREHENSION', 'APPROPRIATION', 'ARBITRATION',
        'ARCHAEOLOGICAL', 'ARCHITECTURE', 'ARTICULATION', 'ASSIMILATION', 'ASSUMPTION', 'ASYMMETRY', 'AUTHENTICATION', 'AUTHORITARIAN', 'AUTOMATION', 'AUTONOMOUS',
        'BENEVOLENCE', 'BIBLIOGRAPHY', 'BIOGRAPHICAL', 'BOTANICAL', 'BUREAUCRACY', 'CAPITALIZATION', 'CARTOGRAPHY', 'CATEGORIZATION', 'CERTIFICATION', 'CIRCULATION',
        'CIVILIZATION', 'CLARIFICATION', 'COLLABORATIVE', 'COMMEMORATE', 'COMMODITY', 'COMMUNICATION', 'COMPARABILITY', 'COMPENSATORY', 'COMPETITIVENESS', 'COMPLEXITY',
        'COMPREHENSION', 'COMPULSORY', 'CONCEPTUALIZATION', 'CONCILIATION', 'CONFIGURATION', 'CONGREGATION', 'CONSCIENTIOUS', 'CONSECUTIVE', 'CONSENSUS', 'CONSERVATIONIST',
        'CONSISTENCY', 'CONSOLIDATION', 'CONSTITUENCY', 'CONSUMPTION', 'CONTAMINATION', 'CONTEMPORARY', 'CONTINGENCY', 'CONTROVERSIAL', 'CONVENTIONAL', 'CORRESPONDENT',
        'CREDENTIALS', 'CREDIBILITY', 'CRIMINOLOGY', 'CRITERION', 'CULTIVATION', 'DECENTRALIZATION', 'DECLARATION', 'DEDICATION', 'DEGRADATION', 'DELIBERATION',
        'DEMOCRATIZATION', 'DEMOGRAPHIC', 'DEPRECIATION', 'DERIVATION', 'DETERIORATION', 'DETERMINATION', 'DETRIMENTAL', 'DEVELOPMENT', 'DICTATORSHIP', 'DIFFERENTIATION',
        'DIGITALIZATION', 'DIMINUTION', 'DISCRIMINATION', 'DISPROPORTIONATE', 'DISSEMINATION', 'DISTINCTIVE', 'DISTRIBUTION', 'DIVERSIFICATION', 'DOCUMENTATION', 'DOMESTICATION',
        'ECOLOGICAL', 'ECONOMICS', 'EDUCATIONAL', 'EFFECTIVENESS', 'ELABORATION', 'ELECTRICITY', 'ELIGIBILITY', 'EMANCIPATION', 'EMBODIMENT', 'EMERGENCE',
        'EMPIRICAL', 'EMPOWERMENT', 'ENCROACHMENT', 'ENDORSEMENT', 'ENFORCEMENT', 'ENHANCEMENT', 'ENLIGHTENMENT', 'ENTREPRENEURIAL', 'ENVIRONMENT', 'EPIDEMIOLOGY',
        'EQUIVALENT', 'ESTABLISHMENT', 'ETHNOGRAPHY', 'EVALUATION', 'EVOLUTIONARY', 'EXAGGERATION', 'EXCLUSION', 'EXEMPTION', 'EXPENDITURE', 'EXPLOITATION',
        'FACILITATION', 'FACTUAL', 'FEDERATION', 'FERTILIZATION', 'FLEXIBILITY', 'FORMALIZATION', 'FRAGMENTATION', 'FUNCTIONALITY', 'GENERALIZATION', 'GEOGRAPHICAL',
        'GLOBALIZATION', 'GOVERNANCE', 'HARMONIZATION', 'HETEROGENEITY', 'HYPOTHETICAL', 'IDENTIFICATION', 'IDEOLOGICAL', 'ILLUSTRATION', 'IMMUNIZATION', 'IMPLEMENTATION',
        'IMPLICATION', 'INCENTIVE', 'INCORPORATION', 'INDEPENDENCE', 'INDIGENOUS', 'INDUSTRIALIZATION', 'INEVITABILITY', 'INFRASTRUCTURE', 'INNOVATION', 'INSTITUTIONAL',
        'INTEGRITY', 'INTELLECTUAL', 'INTERDEPENDENCE', 'INTERPRETATION', 'INTERVENTION', 'INTUITION', 'INVESTMENT', 'IRREVERSIBLE', 'JURISDICTION', 'JUSTIFICATION',
        'LEGITIMACY', 'LIBERALIZATION', 'LONGITUDINAL', 'MAGNITUDE', 'MANIFESTATION', 'MARGINALIZATION', 'MEDIATION', 'METHODOLOGY', 'MINIMALIZATION', 'MISCONCEPTION',
        'MODERNIZATION', 'MULTIPLICATION', 'NEGOTIATION', 'NORMALIZATION', 'OBJECTIVITY', 'OBLIGATION', 'OBSERVATION', 'OPTIMIZATION', 'ORGANIZATIONAL', 'ORIENTATION',
        'PARTICIPATION', 'PERCEPTION', 'PERMANENCE', 'PERSUASION', 'PHENOMENON', 'POLITICIZATION', 'PRACTITIONER', 'PREDOMINANCE', 'PREFERENTIAL', 'PRELIMINARY',
        'PRESERVATION', 'PRESUMPTION', 'PRIORITIZATION', 'PRIVATIZATION', 'PROFESSIONALISM', 'PROLIFERATION', 'PROPORTIONAL', 'PROVISION', 'RATIONALIZATION', 'RECIPROCITY',
        'RECOGNITION', 'RECONCILIATION', 'REDUNDANCY', 'REGENERATION', 'REGULARIZATION', 'REHABILITATION', 'REINFORCEMENT', 'REPRESENTATION', 'REPRODUCTION', 'RESILIENCE',
        'RESPONSIVENESS', 'RESTRUCTURING', 'REVITALIZATION', 'SIGNIFICANCE', 'SPECIALIZATION', 'STANDARDIZATION', 'SUBSIDIARY', 'SUSTAINABILITY', 'SYNTHESIS', 'TERMINOLOGY',
        'TRADITIONAL', 'TRANSITION', 'UNDERSTANDING', 'UNIFORMITY', 'VALIDITY', 'VARIATION', 'VERIFICATION', 'VULNERABILITY'
    ],
    x: [
